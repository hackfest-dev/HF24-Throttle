...
export default function Chat() {
    ...
    console.log(formDetails)
        const newPrompt = `I am an insurance provider, these are the parameters of the user's building: ${formDetails}. Give me a complex risk analysis report with numerical data for the building in a json like table header and data for formdata which I provided, and conclude the verdict. Make multiple columns: criteria, details, remarks and add more columns keep the report precise and data oriented, give reasons for the verdict. Make sure the report looks complex, so that the user feels that you have done some thorough analysis, pack it with old statistical data
        {
            "header": [
                { "label": "Criteria" },
                { "label": "Details" },
